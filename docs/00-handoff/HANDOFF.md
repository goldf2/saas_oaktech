...
## 2026-09-20T08:48:57+08:00 MCP-01 / 0.1.45
13 工具实现和隔离 HTTP 验收完成，见 docs/store-mcp.md 与 evidence/2026-09-20-store-mcp.json。商品/版本创建修改和分别发布，公开 HTTPS 导入，默认无生产权限。下一步推送与公网验证；未配置生产秘密、未连接真实客户端。


## 2026-09-20T09:34:58+08:00 MCP-02 / 0.1.46
页面及真实令牌管理已实现；证据evidence/2026-09-20-mcp-management.json。入口/dashboard?view=mcp，普通账号无权限。后台发放令牌无需每个凭据配置环境变量；旧环境令牌须部署平台管理。待推送/部署验收，本地预览61975端口使用隔离数据。
