...
const initialCatalog: StoreCatalog = {
  ...
  products: [
    ...
    },
    {
      ...
      name_en: "open play",
      name_zh: "open play",
      tagline_en: "Manage local Codex auth profiles and usage.",
      tagline_zh: "管理本地 Codex 认证配置与套餐额度。",
      description_en: "A local-first macOS and Windows utility for importing, switching, exporting, and removing auth.json profiles.",
      description_zh: "面向 macOS 和 Windows 的本地工具，用于导入、切换、导出和移除 auth.json 配置。",
      icon_url: "/open-play/icon.png",
      hero_image_url: "/open-play/hero.png",
      supported_platforms: ["macOS", "Windows"],
      featured: false,
    },
    {
      ...
      name_zh: "缠序 TradingView 缠论工具",
      tagline_en: "Research chart structure and independent signal rules.",
  ...
  releases: [
    {
      id: "bootstrap-open-play-0-6-6-9",
      product_slug: "open-play",
      version: "0.6.6.9",
      channel: "stable",
      status: "published",
      is_current: true,
      published_at: "2026-09-14T00:00:00.000Z",
      title_en: "Cross-platform desktop release",
      title_zh: "跨平台桌面版本",
      notes_en: "macOS and Windows builds with profile switching, quota display, export, and update page access.",
      notes_zh: "包含 macOS 与 Windows 构建、配置切换、额度显示、导出和更新页面入口。",
      release_artifacts: [],
    },
    {
      id: "bootstrap-chanxu-preview",
      product_slug: "chanxu-tradingview",
      version: "0.1.0-preview",
      channel: "preview",
      status: "published",
      is_current: true,
      published_at: "2026-09-14T00:00:00.000Z",
      title_en: "Research preview",
      title_zh: "研究预览版",
      notes_en: "Initial research preview for chart structure and signal screening.",
      notes_zh: "缠论结构观察与信号筛选的初始研究预览版。",
      release_artifacts: [],
    },
    {
