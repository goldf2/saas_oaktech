...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const copy = pageCopy(locale).terms;
  return { title: `${copy.title} - OakTech`, description: locale === "zh" ? "OakTech 软件商店服务条款。" : "Terms of Service for the OakTech software store." };
}
...
export default async function TermsPage() {
  ...
  const copy = pageCopy(locale).terms;
  return (
    <div className="container px-4 py-16 md:py-24" data-page-locale={locale} data-testid="terms-page">
